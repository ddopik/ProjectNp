...
import static com.spade.nrc.nrc.media.player.MusicProvider.MEDIA_ID_EMPTY_ROOT;
import static com.spade.nrc.nrc.media.player.MusicProvider.MEDIA_ID_ROOT;
...
public class MusicService extends MediaBrowserServiceCompat {
    ...
    public static final int NOTIFICATION_ID = 1110;
    ...
    public void onCreate() {
        ...
        mediaNotificationHelper = new MediaNotificationHelper(getApplicationContext());
...
//                handleStopRequest();
    ...
    public void onLoadChildren(@NonNull final String parentMediaId,
        ...
        if (!mMusicProvider.isInitialized()) {
            ...
            mMusicProvider.retrieveMediaAsync(getApplicationContext(), success -> {
                if (success) {
    ...
    private final class MediaSessionCallback extends MediaSessionCompat.Callback {
        ...
        public void onPlayFromMediaId(String mediaId, Bundle extras) {
            ...
            if (media != null) {
                Log.d(TAG, media.getDescription().getTitle().toString());
...
//                            postNotification();
    ...
    private void updatePlaybackState(String error) {
        ...
        if (state == PlaybackStateCompat.STATE_PLAYING) {
            ...
            if (state == PlaybackStateCompat.STATE_PAUSED) {
                mediaNotificationHelper.notify(getNotification());
            } else {
    ...
    private Notification getNotification() {
        mediaNotificationHelper = new MediaNotificationHelper(getApplicationContext());
        Notification notification = MediaNotificationHelper.createNotification(this, mSession, mediaNotificationHelper.CHANNEL_ONE_ID);
