...
public class ShowsAdsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    public static final int SHOW_VIEW_TYPE = 1;
    ...
    public ShowsAdsAdapter(Context context, List<Show> showList, int itemViewType) {
...
//            else
    ...
    public int getItemViewType(int position) {
        return showList.get(position).getType();
    }
